export default function Spinner({ size = 40, color = '#4a9eff' }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '60px 0' }}>
      <svg width={size} height={size} viewBox="0 0 100 80" style={{ animation: 'rewaiqSpin 1.2s ease-in-out infinite' }}>
        <defs>
          <linearGradient id="spF2" x1="0%" y1="0%" x2="90%" y2="100%">
        ...
        <path d="M12.2466 20.8923C9.56504 17.9523 8.61661 13.8979 9.13672 10.6093C9.62504 7.52173 11.9248 5.00455 14.5282 3.27418C15.9203 2.34889 17.5956 1.50727 19.4373 0.975666C20.5603 0.651546 21.7464 1.00602 22.6382 1.76144L98.8583 66.325C99.196 66.611 99.1179 67.1516 98.712 67.3279C90.4102 70.9338 84.6197 72.1928 72.4271 71.665C71.9846 71.6459 71.5565 71.4777 71.2195 71.1903L12.2466 20.8923Z" fill="url(#spF2)"/>
